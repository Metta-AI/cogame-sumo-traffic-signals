...
# Substitute: sumo-traffic-signals, coworld-sumo-traffic-signals, 4.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-sumo-traffic-signals:ci)
#   SMOKE_SLUG                 game slug                        (sumo-traffic-signals)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/sumo-traffic-signals)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/sumo-traffic-signals-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-sumo-traffic-signals:ci}}"
slug="${SMOKE_SLUG:-sumo-traffic-signals}"
